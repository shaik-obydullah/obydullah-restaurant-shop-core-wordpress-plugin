...
Core plugin for the Obydullah Restaurant WooCommerce theme 

== Description ==

Core plugin for the Obydullah Restaurant WooCommerce theme. It includes custom post types, custom fields, and restaurant management features such as:
...
It is recommended for full functionality of the Obydullah Restaurant theme, but can also be used with other restaurant themes with minor adjustments.
...
Yes, but it is optimized for the Obydullah Restaurant theme.
